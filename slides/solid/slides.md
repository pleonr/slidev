...
- Testabilidade:{style="color: lightgreen;"} Classes que cumprem apenas uma responsabilidade têm menos dependências e cenários a serem testados, facilitando a criação de testes unitários.
...
<Youtube id="UOyCsa-FKkI" height="100%" width="100%" />
