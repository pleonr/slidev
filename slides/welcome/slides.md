...
[ead.upf.br](ead.upf.br)

[secure.upf.br](secure.upf.br)

[leon.dev.br](leon.dev.br)
...
A IA como qualquer outra ferramenta deve ser utilizada com ética e responsabilidade.
...
<SlidevVideo class="m-auto -z-5 bottom-0 right-0 left-0 max-h-120" controls>
  <!-- Anything that can go in an HTML video element. -->
  <source src="/brenolvrabelo.mp4" type="video/mp4" />
  <p>
    Your browser does not support videos. You may download it
    <a href="/brenolvrabelo.mp4">here</a>.
  </p>
</SlidevVideo>
...
<SlidevVideo class="m-auto -z-5 bottom-0 right-0 left-0 max-h-120" controls>
  <!-- Anything that can go in an HTML video element. -->
  <source src="/pauloia.mp4" type="video/mp4" />
  <p>
    Your browser does not support videos. You may download it
    <a href="/pauloia.mp4">here</a>.
  </p>
</SlidevVideo>
